...
const validatedBodyPet: RequestHandler = (req, res, next) => middlewareValidadorBodyPet(req, res, next);

router.post("/", validatedBodyPet, (req, res) => petController.criaPet(req, res));
...
router.get("/filtro", (req, res) => petController.buscaPorCampoGenerico(req, res))
